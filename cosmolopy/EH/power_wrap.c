...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__power

#else
#  define SWIG_init    init_power

#endif
#define SWIG_name    "_power"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_TFmdm_set_cosm(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOO:TFmdm_set_cosm",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_TFmdm_onek_mpc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:TFmdm_onek_mpc",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_float(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
SWIGINTERN PyObject *_wrap_TFmdm_onek_hmpc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  float arg1 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:TFmdm_onek_hmpc",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_float(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
SWIGINTERN int Swig_var_tf_cbnu_set(PyObject *_val) {
  {
    float val;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"TFmdm_set_cosm", _wrap_TFmdm_set_cosm, METH_VARARGS, NULL},
	 { (char *)"TFmdm_onek_mpc", _wrap_TFmdm_onek_mpc, METH_VARARGS, NULL},
	 { (char *)"TFmdm_onek_hmpc", _wrap_TFmdm_onek_hmpc, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"tf_cbnu",Swig_var_tf_cbnu_get, Swig_var_tf_cbnu_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
